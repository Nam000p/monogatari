...
public class FollowAdapter extends RecyclerView.Adapter<FollowAdapter.FollowViewHolder> {
    private final List<FollowResponse> items = new ArrayList<>();
    ...
    public FollowAdapter(OnItemClickListener listener) {
        this.listener = listener;
    }

    @SuppressLint("NotifyDataSetChanged")
    public void setItems(List<FollowResponse> newItems) {
        this.items.clear();
        if (newItems != null) {
    ...
    public void onBindViewHolder(@NonNull FollowViewHolder holder, int position) {
        FollowResponse item = items.get(position);
    ...
    static class FollowViewHolder extends RecyclerView.ViewHolder {
        ...
        FollowViewHolder(ItemStoryPosterBinding binding) {
